...
## Install
If you just want to use fb-chat-support, you should use this command:
```bash
npm install fb-chat-support
```
It will download `fb-chat-support` from NPM repositories

### Bleeding edge
If you want to use bleeding edge (directly from github) to test new features or submit bug report, this is the command for you:
```bash
npm install KhangGia1810/fb-chat-support
```
